...
ath.intl = {
	...
	en_us: {
		ios: 'To Download Augur as an app, select: <strong>Add to Home Screen</strong>.',
		android: 'To Download Augur as an app, select: <strong>Add to homescreen</strong>. <small>The menu can be accessed by pressing the menu hardware button if your device has one, or by tapping the top right menu icon %icon.</small>'
	},
